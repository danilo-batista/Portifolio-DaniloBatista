        ...
        <ul>
          <li className={styles.experience__container}>
            <Link to="https://turmadamonica.uol.com.br/">
              <img
                src={`/images/brand-mspestudios_logo.png`}
              ...
              <details className={styles.experience__resume}>
                ...
                <ul>
                  <li className={styles.resume__listItems}>
                    ...
                    quadrinhos e facilitou a expansão para mercados
                    internacionais por meio da personalização dos diálogos em
                    diferentes idiomas.
                  </li>
                </ul>
              </details>
          ...
          <li className={styles.experience__container}>
            <Link to="https://www.multilaser.com.br/">
              <img
                src={`/images/brand-grupoMulti-color.png`}
              ...
              <details className={styles.experience__resume}>
                ...
                <ul>
                  ...
                  <li className={styles.resume__listItems}>
                    ...
                    por uma agência externa de branding, em embalagens e
                    produtos.
                  </li>
                  <li className={styles.resume__listItems}>
          ...
          <li className={styles.experience__container}>
            <Link to="https://alfaflex.com.br/">
              <img
                src={`/images/brand-alfaflex-color.png`}
            ...
            <div className={styles.experience__jobContext}>
              ...
              <br />
              <span>
                Obs.: No período em que eu trabalhei nesta empresa, ela era
                conhecida como <strong>Condugraf Produtos Eletrônicos</strong>.
              </span>
              ...
              <details className={styles.experience__resume}>
                ...
                <ul>
                  <li className={styles.resume__listItems}>
                    ...
                    custos e aumentando a produtividade, tanto na relação Vendas
                    e Clientes quanto no processo de Produção Gráfica de toda a
                    empresa.
                  </li>
                </ul>
              </details>
