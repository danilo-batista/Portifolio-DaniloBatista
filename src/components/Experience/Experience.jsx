    ...
    <>
      <section className={styles.section}>
        <div className={styles.container}>
          <article>
            <h2 className={styles.experience__title}>Experiências</h2>
              ...
              <li className={styles.experience__container}>
                ...
                <div className={styles.experience__jobContext}>
                  ...
                  <details className={styles.experience__resume}>
                    ...
                    <ul>
                      <li className={styles.resume__listItems}>
                        Atualizei layouts de embalagens dos produtos de marca
                        própria.
                      </li>
                      <li className={styles.resume__listItems}>
                        Realizei estudos de viabilidade de materiais gráficos,
                        como embalagens, manuais de instruções e materiais de
                        ponto de venda.
                      </li>
                      <li className={styles.resume__listItems}>
                        Coordenei a equipe interna de designers e produtores
                        gráficos.
                      </li>
                      <li className={styles.resume__listItems}>
              ...
              <li className={styles.experience__container}>
                ...
                <div className={styles.experience__jobContext}>
                  ...
                  <details className={styles.experience__resume}>
                    ...
                    <ul>
                      <li className={styles.resume__listItems}>
                        Desenvolvi embalagens de acessórios de informática e
                        cartuchos de impressora.
                      </li>
                      <li className={styles.resume__listItems}>
                        Criei projetos de comunicação interna em parceria com a
                        área de Recursos Humanos.
                      </li>
                      <li className={styles.resume__listItems}>
                        Ofereci, por meio de materiais gráficos, todo o suporte
                        à equipe comercial.
                      </li>
                      <li className={styles.resume__listItems}>
                      ...
                      <li className={styles.resume__listItems}>
                        Realizei visitas técnicas a gráficas, validando as
                        parcerias em conjunto com a área de compras.
                      </li>
                      <li className={styles.resume__listItems}>
                        Inspecionei embalagens importadas diretamente no centro
                        de distribuição.
                      </li>
                      <li className={styles.resume__listItems}>
                        Desenvolvi o design de embalagens para diversas linhas
                        de produtos da empresa.
                      </li>
                      <li className={styles.resume__listItems}>
                        Apoiei tecnicamente o redesign da marca principal,
                        realizado por uma agência externa de branding, em
                        embalagens e produtos.
                      </li>
                      <li className={styles.resume__listItems}>
                        Criei materiais de divulgação em formato de e-mail
                        marketing para o time de vendas.
                      </li>
                      <p className={styles.resume__listItemsTopic}>
                        Projeto especial desenvolvido com êxito:
                      </p>
                      <li className={styles.resume__listItems}>
                        Liderei o projeto de redesign de toda a linha de
                        embalagens com a equipe de designers, integrando
                        diversas áreas envolvidas, desde os fornecedores até o
                        time de vendas, atingindo os seguintes objetivos:
                        <br />
                        1) Aumento da visibilidade e relevância dos produtos.
                        <br />
                        2) Recuperação e ampliação do espaço anteriormente
                        perdido para concorrentes nos pontos de venda.
                      </li>
                      <li className={styles.resume__listItems}>
                        Dirigi a parte artística dos catálogos de produtos,
                        transformando-os nas principais ferramentas de conversão
                        de vendas.
                      </li>
                    </ul>
                  </details>
                ...
                <div className={styles.experience__jobContext}>
                  ...
                  <details className={styles.experience__resume}>
                    ...
                    <ul>
                      ...
                      <li className={styles.resume__listItems}>
                        Determinei o processo gráfico destes produtos em
                      ...
                      <li className={styles.resume__listItems}>
                        ...
                        Desenvolvimento de Produtos Gráficos, em conformidade
                        com a norma ISO9001, melhorando seu entendimento e uso.
                      </li>
                      <p className={styles.resume__listItemsTopic}>
                        Projeto especial desenvolvido com êxito:
                      </p>
                      <li className={styles.resume__listItems}>
                        Criei uma escala física de cores "Condugraf", reduzindo
                        custos e aumentando a produtividade, tanto na relação
                        Vendas e Clientes quanto no processo de Produção Gráfica
                        de toda a empresa.
                      </li>
                    </ul>
                  </details>
